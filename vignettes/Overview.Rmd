...
read in to memory in their entirety using `readFastq`; we do
...
**Table 2:** Primary data types in the `r Biocpkg("ShortRead")` package.
...
(_Bioconductor_ version 2.13) contain a vignette illustrating common
