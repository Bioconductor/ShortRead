...
in the `ShortRead` package is that all files matching
...
related classes are used extensively in _ShortRead_,
_Biostrings_, _BSgenome_ and other packages relevant
