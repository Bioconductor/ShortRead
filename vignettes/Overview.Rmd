...
date: "Modified: 21 October 2013. Compiled: `r format(Sys.Date(), '%B %d, %Y')`"
package: ShortRead
vignette: >
...
alignment are encouraged to investigate the `r Biocpkg("Biostrings")` package,
especially the _PDict_ class and `matchPDict` and `pairwiseAlignment` functions.
