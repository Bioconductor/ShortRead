...
<<report, eval=FALSE>>=
report(qa, dest="/path/to/qa_report.pdf")
@ 
%% 
...
Duplicate reads can be identified with \Rfunction{srduplicated}, which
returns a logical vector much like \Rfunction{duplicated}.
